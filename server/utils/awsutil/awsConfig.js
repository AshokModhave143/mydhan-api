...
const { apiVersion, accessKeyId, secretAccessKey, region, s3BucketName } =
  getConfig();
...
const snsConfig = {
  ...
  SmsTargetArn:
    "arn:aws:sns:ap-southeast-2:346264802683:MydhanNotification:d0983272-e75f-46f1-a635-d6c83d11e7cc",
  EmailTargetArn:
    "arn:aws:sns:ap-southeast-2:346264802683:MydhanNotification:b382de07-6edc-4dcd-9eb8-e8fc72130b63",
};
